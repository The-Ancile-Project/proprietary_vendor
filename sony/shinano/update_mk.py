...
replace_in_file('proprietary/Android.mk', 'ifneq ($(filter shinano shinano2,$(PRODUCT_PLATFORM)),)', 'endif', definitions)
replace_in_file('shinano-partial.mk', 'PRODUCT_PACKAGES += \\', None, packages)
