...
worklist = [
    ('bin/', 'Sony Mobile', 'EXECUTABLES', '$(TARGET_OUT)'),
    ('sbin/', 'Sony Mobile', 'EXECUTABLES', '$(TARGET_ROOT_OUT)'),
    ('etc/', 'Sony Mobile', 'ETC', '$(TARGET_OUT)'),
    ('framework/', 'Sony Mobile', 'SHARED_LIBRARIES',  '$(TARGET_OUT)'),
    ('lib/', 'Sony Mobile', 'SHARED_LIBRARIES',  '$(TARGET_OUT)'),
    ('vendor/', 'Sony Mobile', 'SHARED_LIBRARIES',  '$(TARGET_OUT)'),
]
...
replace_in_file('proprietary/Android.mk', 'ifeq ($(PRODUCT_PLATFORM),yukon)', 'endif', definitions)
replace_in_file('yukon-partial.mk', 'PRODUCT_PACKAGES += \\', None, packages)
